clear @s
give @s minecraft:shield{Enchantments:[{id:"minecraft:knockback",lvl:1s}],Unbreakable:1,Visclear:1b,AttributeModifiers:[{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Amount:0.0d,Operation:0,UUIDMost:46351,UUIDLeast:170121,Slot:"mainhand"}],display:{Name:"[{\"text\":\"\"},{\"text\":\"惡作劇之盾\",\"color\":\"gold\",\"bold\":\"true\"}]",Lore:["\"身形龐大的鬼使用的\"","\"附著詭異圖案的盾。\""]},HideFlags:32,BlockEntityTag:{Base:10,Patterns:[{Pattern:cbo,Color:15},{Pattern:mc,Color:15},{Pattern:tt,Color:15},{Pattern:mr,Color:15}],Base:0}}
