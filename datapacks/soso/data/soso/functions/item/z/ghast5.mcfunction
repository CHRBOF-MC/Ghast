...
give @s minecraft:diamond_shovel{Enchantments:[{id:"minecraft:knockback",lvl:1s}],Unbreakable:1,Visclear:1b,AttributeModifiers:[{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Amount:-0.9d,Operation:0,UUIDMost:46351,UUIDLeast:170121,Slot:"mainhand"}],display:{Name:"[{\"text\":\"\"},{\"text\":\"惡作劇之槍\",\"color\":\"gold\",\"bold\":\"true\"}]",Lore:["\"形貌兇惡的鬼使用的\"","\"綻放著幽藍之火的槍。\""]}}
