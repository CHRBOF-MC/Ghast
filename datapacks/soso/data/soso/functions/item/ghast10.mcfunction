...
tag @s add g10
tag @s add start
give @s minecraft:pufferfish_bucket{Enchantments:[{id:"minecraft:knockback",lvl:2s}],Unbreakable:1,Visclear:1b,AttributeModifiers:[{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Amount:-0.8d,Operation:0,UUIDMost:46351,UUIDLeast:170121,Slot:"mainhand"}],display:{Name:"[{\"text\":\"\"},{\"text\":\"惡作劇之桶\",\"color\":\"gold\",\"bold\":\"true\"}]",Lore:["\"暴躁的鬼使用的\"","\"綻放著幽藍之火的桶。\""]}}
...
execute as @a at @s run playsound minecraft:entity.tnt.primed block @a
tellraw @a [{"text":"道士的活躍觸怒了嬉鬼！","color":"red","bold":true}]
tellraw @a [{"text":"暴躁的","color":"red","bold":true},{"text":"爆鬼","color":"dark_red","bold":true},{"text":"現身了！","color":"red","bold":true}]
