...
execute unless score shield zTEST matches 1 run item replace entity @s[tag=onF,scores={know=30..},tag=!knowon] weapon.offhand with minecraft:white_banner{Nonknow:1b,BlockEntityTag:{Base:10,Patterns:[{Pattern:cbo,Color:4},{Pattern:mc,Color:4},{Pattern:tt,Color:4},{Pattern:mr,Color:4}]},AttributeModifiers:[{AttributeName:"generic.knockback_resistance",Name:"generic.knockback_resistance",Amount:100.0d,Operation:0,UUID:[I;493758772,329335813,287137220,275225176],Slot:"offhand"}],HideFlags:32,display:{Name:"[{\"text\":\"\"},{\"text\":\"抗退護符\",\"color\":\"gold\",\"bold\":\"true\"}]",Lore:["\"放置副手能抵抗鬼的擊退共20秒，\"","\"放置於主手可緩慢恢復抵抗時間。\"","\"自然填補率：10%。\""]}}
execute if score shield zTEST matches 1 run item replace entity @s[tag=onF,scores={know=30..},tag=!knowon] weapon.offhand with minecraft:shield{Unbreakable:1,Nonknow:1b,BlockEntityTag:{Base:0,Patterns:[{Pattern:cbo,Color:4},{Pattern:mc,Color:4},{Pattern:tt,Color:4},{Pattern:mr,Color:4}]},AttributeModifiers:[{AttributeName:"generic.knockback_resistance",Name:"generic.knockback_resistance",Amount:100.0d,Operation:0,UUID:[I;493758772,329335813,287137220,275225176],Slot:"offhand"}],HideFlags:32,display:{Name:"[{\"text\":\"\"},{\"text\":\"抗退護盾\",\"color\":\"gold\",\"bold\":\"true\"}]",Lore:["\"放置副手能抵抗鬼的擊退共20秒，\"","\"放置於主手可緩慢恢復抵抗時間。\"","\"自然填補率：10%。\""]}}
tag @s[tag=onF,scores={know=30..}] add knowon

execute unless score shield zTEST matches 1 run item replace entity @s[tag=onF,scores={know=..10},tag=knowon] weapon.offhand with minecraft:white_banner{Nonknow:1b,BlockEntityTag:{Base:10,Patterns:[{Pattern:cbo,Color:4},{Pattern:mc,Color:4},{Pattern:tt,Color:4},{Pattern:mr,Color:4}]},HideFlags:32,display:{Name:"[{\"text\":\"\"},{\"text\":\"抗退護符\",\"color\":\"gold\",\"bold\":\"true\"}]",Lore:["\"放置副手能抵抗鬼的擊退共20秒，\"","\"放置於主手可緩慢恢復抵抗時間。\"","\"自然填補率：10%。\""]}}
execute if score shield zTEST matches 1 run item replace entity @s[tag=onF,scores={know=..10},tag=knowon] weapon.offhand with minecraft:shield{Unbreakable:1,Nonknow:1b,BlockEntityTag:{Base:0,Patterns:[{Pattern:cbo,Color:4},{Pattern:mc,Color:4},{Pattern:tt,Color:4},{Pattern:mr,Color:4}]},HideFlags:32,display:{Name:"[{\"text\":\"\"},{\"text\":\"抗退護盾\",\"color\":\"gold\",\"bold\":\"true\"}]",Lore:["\"放置副手能抵抗鬼的擊退共20秒，\"","\"放置於主手可緩慢恢復抵抗時間。\"","\"自然填補率：10%。\""]}}
