...
give @s minecraft:white_banner[custom_data={raggo:1b,tyse:4b},base_color="purple",banner_patterns=[{pattern:"minecraft:curly_border",color:"purple"},{pattern:"minecraft:circle",color:"purple"},{pattern:"minecraft:triangle_top",color:"purple"},{pattern:"minecraft:rhombus",color:"purple"}],tooltip_display={hidden_components:["banner_patterns"]},custom_name=[{"text":""},{"text":"惡鬼嘶吼","color":"gold","bold":true}],lore=["放置副手能將敵我全員震飛(一次性)。"]]
give @s minecraft:white_banner[custom_data={raggo:1b,tyse:1b},base_color="purple",banner_patterns=[{pattern:"minecraft:curly_border",color:"purple"},{pattern:"minecraft:circle",color:"purple"},{pattern:"minecraft:triangle_top",color:"purple"},{pattern:"minecraft:rhombus",color:"purple"}],tooltip_display={hidden_components:["banner_patterns"]},custom_name=[{"text":""},{"text":"惡鬼嘶吼","color":"gold","bold":true}],lore=["放置副手能將敵我全員震飛(一次性)。"]]
give @s minecraft:white_banner[custom_data={raggo:1b,tyse:2b},base_color="purple",banner_patterns=[{pattern:"minecraft:curly_border",color:"purple"},{pattern:"minecraft:circle",color:"purple"},{pattern:"minecraft:triangle_top",color:"purple"},{pattern:"minecraft:rhombus",color:"purple"}],tooltip_display={hidden_components:["banner_patterns"]},custom_name=[{"text":""},{"text":"惡鬼嘶吼","color":"gold","bold":true}],lore=["放置副手能將敵我全員震飛(一次性)。"]]
