clear @s
give @s minecraft:diamond_axe{Enchantments:[{id:"minecraft:knockback",lvl:1s}],Unbreakable:1,Visclear:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:0.3d,Operation:0,UUID:[I;493758772,329335813,287137220,275225176],Slot:"mainhand"}],display:{Name:"[{\"text\":\"\"},{\"text\":\"惡作劇之斧\",\"color\":\"gold\",\"bold\":\"true\"}]",Lore:["\"形貌兇惡的鬼使用的\"","\"綻放著幽藍之火的斧。\""]}}
