...
tag @s add g7
tag @s add start
give @s minecraft:diamond_block{Enchantments:[{id:"minecraft:knockback",lvl:1s}],nonslow:1b,Unbreakable:1,Visclear:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:-0.2d,Operation:0,UUID:[I;493758772,329335813,287137220,275225176],Slot:"mainhand"}],display:{Name:"[{\"text\":\"\"},{\"text\":\"惡作劇之磚\",\"color\":\"gold\",\"bold\":\"true\"}]",Lore:["\"輕快的鬼使用的\"","\"綻放著幽藍之火的磚。\""]}}
