...
tag @s add g7
tag @s add start
give @s minecraft:diamond_block[custom_data={nonslow:1b,Visclear:1b},enchantments={"minecraft:knockback":1},unbreakable={},attribute_modifiers=[{type:"attack_damage",amount:-0.2d,operation:"add_value",id:"1d6e2934-13a1-4405-111d-5dc410679a58",slot:"mainhand"}],custom_name=[{"text":""},{"text":"惡作劇之磚","color":"gold","bold":true}],lore=["輕快的鬼使用的","綻放著幽藍之火的磚。"]]
