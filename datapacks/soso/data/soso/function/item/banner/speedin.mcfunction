...
execute unless items entity @s weapon.offhand *[minecraft:custom_data~{speedin:1b}] unless data entity @s SelectedItem.components.minecraft:custom_data{speedin:1b} run tag @s add onA
execute unless items entity @s weapon.offhand *[minecraft:custom_data~{speedin:1b}] if data entity @s SelectedItem.components.minecraft:custom_data{speedin:1b} run tag @s add onS
execute if items entity @s weapon.offhand *[minecraft:custom_data~{speedin:1b}] unless data entity @s SelectedItem.components.minecraft:custom_data{speedin:1b} run tag @s add onF
