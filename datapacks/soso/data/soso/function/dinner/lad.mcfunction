...
execute if score timestay zTEST matches 0 as @a at @s run function soso:dinner/stayend
execute if score timestay zTEST matches 0 as @a at @s run kill @e[tag=tp]
execute if score timestay zTEST matches 1.. run schedule function soso:dinner/lad 1t