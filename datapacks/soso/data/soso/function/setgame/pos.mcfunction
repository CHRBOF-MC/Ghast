...
execute if score pos zTEST matches 0 run data merge block ~ ~ ~ {Text2:"{\"text\":\"歪斜宅邸\",\"color\":\"white\",\"bold\":true}"}
execute if score pos zTEST matches 1 run data merge block ~ ~ ~ {Text2:"{\"text\":\"異空庭園\",\"color\":\"white\",\"bold\":true}"}
execute if score pos zTEST matches 2 run data merge block ~ ~ ~ {Text2:"{\"text\":\"惡食餐桌\",\"color\":\"white\",\"bold\":true}"}
execute if score pos zTEST matches 3 run data merge block ~ ~ ~ {Text2:"{\"text\":\"腥紅肉壁\",\"color\":\"white\",\"bold\":true}"}
