...
execute as @a if items entity @s weapon.offhand *[minecraft:custom_data~{raggo:1b}] at @s run function soso:skill/ravager
execute as @a if items entity @s weapon.offhand *[minecraft:custom_data~{raggo:1b}] run item replace entity @s weapon.offhand with air
...
execute as @a store result score @s ramdon run clear @s *[minecraft:custom_data~{fly:1b}] 0
execute as @a if score @s ramdon matches 1.. run function soso:item/banner/fly
...
execute as @a store result score @s ramdon run clear @s *[minecraft:custom_data~{cai:2b}] 0
execute as @a if items entity @s weapon.mainhand *[minecraft:custom_data~{cai:1b}] if score @s ramdon matches 0 run function soso:alltimeuse/cai
execute as @a unless items entity @s weapon.mainhand *[minecraft:custom_data~{cai:1b}] if score @s ramdon matches 1.. run function soso:alltimeuse/caiclear
...
execute as @a store result score @s ramdon run clear @s *[minecraft:custom_data~{Nonknow:1b}] 0
execute as @a if score @s ramdon matches 1.. run function soso:item/banner/knockback
execute as @a store result score @s ramdon run clear @s *[minecraft:custom_data~{speedin:1b}] 0
execute as @a if score @s ramdon matches 1.. run function soso:item/banner/speedin
execute as @a store result score @s ramdon run clear @s *[minecraft:custom_data~{sfall:1b}] 0
execute as @a if score @s ramdon matches 1.. run function soso:item/banner/sfall
execute as @a store result score @s ramdon run clear @s *[minecraft:custom_data~{zombiesum:1b}] 0
execute as @a if score @s ramdon matches 1.. run function soso:item/banner/zombiesum
execute as @a if items entity @s weapon.offhand *[minecraft:custom_data~{creeper:1b}] run function soso:skill/creeper
execute as @a[scores={Hurt=60..}] store result score @s ramdon run clear @s *[minecraft:custom_data~{attup:1b}] 0
execute as @a[scores={Hurt=60..}] if score @s ramdon matches 1.. run function soso:item/banner/attup
...
execute as @e[type=minecraft:item] run data merge entity @s {Invulnerable:1b,PickupDelay:0}
execute as @e[type=minecraft:item] if data entity @s Owner at @a run function soso:item/flyback
